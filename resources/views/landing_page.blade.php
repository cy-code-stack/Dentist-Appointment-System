...
@section('content')
    <div class="main-container container-fluid bg-primary">
        <nav class="navbar bg-body-transparent p-2 mb-2">
            <div class="logo">
                <span class="navbar-brand mb-0 h1 ms-3"><img class="image-fluid me-2" src="{{ asset('images/logo.png') }}" alt="logo-img"><span class="text-white">Graces Dental Clinic</span></span>
                <a class="nav-link me-4 text-white fw-medium" href="{{ route('signin') }}">Login</a>
            </div>
        </nav>
        <div class="container-xl d-flex align-items-center justify-content-center mb-5">
            <div class="col mt-3">
                <div class="col">
                    <h1 class="fw-semibold mb-2 text-white" style="font-size: 3rem;">Book your Online Appointment Now</h1>
                </div>
                <div class="col col-lg-11">
                    <p class="text-white fs-6 mb-3" style="text-align: justify;">Welcome to Graces Dental Clinic, where scheduling appointments is simple and convenient. 
                        Whether you're a individual, or anyone in needs our service,
                        we've got you covered.</p>
                </div>
                <div class="d-flex align-items-start">
                    <div class="btn btn-light btn-lg me-2">Get your appointment</div>
                </div>
            </div>  
            <div class="col mt-3">
    ...
    <div class="container-lg mt-5">
        <div class="section-procedure">
            ...
            <p class="text-center">The appointment is simple yet effective. Just follow these steps to ensure your appointment works well.</p>
        </div>
    </div>
    ...
    <div class="section-procedure-icon">
        <div class="container text-center">
            ...
            <div class="content text-center mt-5">
                ...
                <p class="fw-4">You can easily schedule appointments for any of our medical services without any inconvenience.</p>
            </div>
        </div>
        ...
        <div class="container text-center">
            ...
            <div class="content text-center mt-5">
                ...
                <p class="fw-4">You'll receive a confirmation email with your appointment details shortly. Keep an eye on your inbox.</p>
            </div>
        </div>
    ...
    <div class="services container-fluid d-flex flex-column align-items-center mb-5 min-vh-100">
        <div class="container-lg">
            <div class="section-procedure">
                ...
                <p class="text-center">Our company offers a range of services designed to meet your needs.</p>
            </div>
        </div>
       ...
       <div class="footer-nav d-flex justify-content-center align-items-center">
            ...
            <div class="col col-md-3">
               <div class="icon-text">
                ...
                <i class='bx bx-current-location text-white'><span class="ms-2 text-break">Eleventh Street Business Complex, 2nd floor, National Highway, Purok 5, San Francisco Poblacion, Panabo, Davao Region, Philippines</span></i>
                <i class='bx bx-envelope text-white'><span class="ms-2">Oconrenegrace@gmail.com</span></i><br>
                <a href="https://www.facebook.com/DrGraceOconTabudlong"><i class='bx bxl-facebook-circle text-white fs-6'><span class="ms-2">Graces Dental Clinic</span></i></a><br>
            ...
            <div class="last-footer col col-lg-7">
                ...
                <p class="text-center text-white text-break fs-6">Grace's Dental Clinic ensures effortless access to dental care with our user-friendly web appointment, allowing patients to schedule appointments conveniently from the comfort of their homes.</p>
            </div>
       </div>
    </div>
@endsection