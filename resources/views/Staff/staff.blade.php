        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light ">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/staff/dashboard" class="nav-link ms-4">Staff Dashboard</a>
                </li>
            </ul>
        </nav>
        <aside class="main-sidebar sidebar-light-primary elevation-1">
            <a href="/staff/dashboard" class="brand-link text-decoration-none">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <router-link to="/staffappointment" class="nav-link">
                            ...
                            <li class="nav-item">
                                <router-link to="/staffservices" class="nav-link">
                            ...
                            <li class="nav-item">
                                <router-link to="/staffprofile" class="nav-link">
